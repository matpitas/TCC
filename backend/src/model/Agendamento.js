...
const getNearAgendamentoById = async (id) => {
    const query = 'SELECT * FROM agendamentos a, jogos j WHERE a.idJogo = j.idJogo and a.usuarioCriador = ? and a.status = 1 and a.iniciaEm > CURDATE()  ORDER BY `iniciaEm` asc LIMIT 1 '
